...
class _VerificationCodeState extends State<VerificationCode>
  ...
  Future<void> _handleContinue() async {
    ...
    setState(() {
      ...
      if (_wrongAttempts >= 5) {
        ...
        _errorText =
            "Incorrect code. Make sure you're using the latest one sent.";
      } else {
  ...
  /// Handles auto-pasting 4-digit codes directly into the fields
  void _onCodeChanged(String value, int index) {
    ...
    // Handle full OTP Paste (e.g. user pastes "1234")
    if (value.length > 1) {
    ...
    // Standard single character navigation
    if (value.isNotEmpty) {
      if (index < 3) {
      ...
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final double boxSize = (fieldWidth - 3 * 12) / 4 > 56
                ? 56
                : (fieldWidth - 3 * 12) / 4;
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: (_isCodeComplete && !_isExpired && !_isLocked)
                            ? _handleContinue
                            : null,
                        child: Text(
                          "Continue",
