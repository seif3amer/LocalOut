...
class _CartScreenState extends State<CartScreen> {
  ...
  // ==================== كارت منتج واحد ====================
  // XL بادچ ملزوز تمامًا في الزاوية العلوية اليمين للكارت (بره الـ padding)
  // وسلة الزبالة نازلة في آخر العمود اليمين
    ...
    return Padding(
      ...
      child: Stack(
        ...
        children: [
                ...
                Expanded(
                  child: Row(
                    ...
                    children: [
                      ...
                      // عمود يمين فاضي غير سلة الزبالة نازلة تحت
                      SizedBox(
                        height: 100,
                        child: Align(
          ...
          // XL badge ملزوز في زاوية الكارت العلوية اليمين (top:0, right:0 = حافة الكارت الحقيقية)
          Positioned(
            top: 0,
            right: 0,
            child: Container(
